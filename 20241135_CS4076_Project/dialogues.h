...
// Struct containing some printing functions.
struct Dialogues{
    static string printCurrentRoom(string& description);
    static string printAttemptsLeft(int& attemptsLeft);
};

namespace OtherDialogues{
const string welcome = "This is Wordleville, a harsh world"
...
const string inputError = "Invalid command, please try again.\n";

const string noMoreRooms = "No more areas this way. Try another direction.\n";

const string welcomeWordle = "Ohh snap! It's a Wordle challenge! Input your attempt right now!!\n";

const string wordleIncorrectInput = "Please input a 5 letter word.\n";

const string wordleSuccess = "Congratulations! You have guessed the correct word!\n";

const string wordleOutOfAttempts = "Oof! You have run out of attempts!\n";
